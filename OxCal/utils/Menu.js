...
/*  document.writeln("<button style='height:25px;width:32px;background-color:rgba(255,255,255,0.5);border-width:1px;-moz-border-radius: 4px;-webkit-border-radius: 4px' onclick='"+action+"'>"+
 ...
 function chooseRocker(b,chosen)
 {
  var col='white';
  if(chosen)
  {
  ...
  b.style.caretColor=col;
  b.style.color=col;
 };
 function Rocker(map)
 {
  document.writeln("<input title='Select and use arrow keys\nAlt for smaller movements' id='"+map+"' style='margin:3px;padding:5px;border:0px;border-radius:5px;height:0px;width:0px;background-color:white;color:white;cursor:move;caret-color:white;overflow:none' onfocus='chooseRocker(this,true)' onblur='chooseRocker(this,false)' onkeydown= 'keyHandler(event,\""+map+"\")'></input>");
