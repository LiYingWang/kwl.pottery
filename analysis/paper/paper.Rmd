...
Outlines generated by EFA are examined by principal components analysis to explore the shape variations across three phases. The first two principal components (PCs) explain `r vari_two`% of variances, and the first three principal components (PCs) explain `r vari_three`% of variances. The PC1 relate to the height of the vessels from short to high, the PC2 reflects the neck and mouth constriction from wide to narrow, and the PC3 relates to the degree of flare of neck from curved to straight shape. The contribution of each principal component on the shape of vessels was listed in table (). The PC1 relative to the hight of the vessels accounts for nearly half of variances. Figure\@ref(fig:first-two-PCs-byplot) shows that a wider variation in pottery shape from the pre-European and post-European period compared to those from Chinese period. 
