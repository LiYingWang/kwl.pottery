...
More standardized pottery shape without controlling the clay paste or changes in technology suggests the shape as a preferred characteristic in pottery production. In addition to the appearance of specialized groups, another explanation could be related to an act of resistance to the Chinese immigrant by emphasizing the traditional pottery production practice, of which shape is a visible trait for. @Raux2015
