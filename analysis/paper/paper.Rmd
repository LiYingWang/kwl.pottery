...
```{r size-regression, fig.cap= "A: Distribution of the body diameter of the vessels across three phases. B: Scatter plots of shape variable, PC1 at the top and PC2 at the bottom, as a function of body diamater"}
