...
The mean petal shape of each variety was then drawn using the mean values of the standardized Fourier coefficients within each variety. Figure 1 shows the wide variation of petal shape that was observed among the varieties examined in this study.
