...
Whether standardization reflects an emergence of specialized production is associated with the number of producers, which distinguishes mechanical standardization from intentional standardization expressed by stylish and functional attributes [@Costin2001; @Costin1995]. In other words, mechanical standardization depends on potter's skills and experiences that increased morphological uniformity normally reflects fewer producers. The population could be an indicator to estimate potential number of producer. According to the historical records [@Nakamura1938, pp. 12], the population in Kiwulan reached higher number in the 17th century as the European presence and then decreased in the Chinese period due to a movement of indigenous people to the south [@Chen2007]. The decline in population is supported by ceramic abundance in total, which indicates less population might be a factor leading to higher standardization in the Chinese period. 
