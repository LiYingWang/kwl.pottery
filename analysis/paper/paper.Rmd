...
Whether standardization reflects an emergence of specialized production is associated with the number of producers, which distinguishes mechanical standardization from intentional standardization [@Costin2001; @Costin1995]. In other words, mechanical standardization depends on potter's skills and experiences that increased uniformity normally reflects fewer producers.
