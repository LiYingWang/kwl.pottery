...
The standardization of pottery shape for each phase is explored by the distributions of the first three PC scores for each vessel that suggests variations in shape standardization by phase. The first PC, the hight of the vessels, shows more variations in the pre-Euro period compared to the Chinese period. That shows standardization appears strong in the Chinese period but weak in the pre-European period. To see whether the differences of the distribution of PCs between each phase is statistically significant, coefficients of variation statistic (CVs) among phase groups of PCs is examined with a modified signed-likelihood ratio test for the equality of CVs. P-values for the significant test of equality of CVs of PC1 and PC2 show significant differences in standardization of vessel shape across some periods, especially between Chinese contact with either pre-European or post-European. 
