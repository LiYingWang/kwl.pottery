...
RUN . /etc/environment \
  ...
  && R -e "remotes::install_deps('/kwl.pottery', dep=TRUE, repos='http://cran.rstudio.com/')" \
  && R -e "remotes::install_github(c('benmarwick/rrtools', 'benmarwick/wordcountaddin'), dependencies=TRUE)" \
